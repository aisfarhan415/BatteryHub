...
*   `Widget.BatteryHub`: The widget extension for the iOS Home Screen / Lock Screen.
*   `BatteryHubWatch Watch App`: The watchOS application target.
...
```bash
   git clone [https://github.com/aisfarhan4515/BatteryHub.git](https://github.com/aisfarhan4515/BatteryHub.git)
```

2. Open the project file in Xcode:

```Bash
   open BatteryHub.xcodeproj
```
Select your desired target (BatteryHub or BatteryHubWatch Watch App).
